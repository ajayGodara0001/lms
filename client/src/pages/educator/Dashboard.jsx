    ...
    <div className="p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-blue-100 p-6 rounded-lg shadow-md text-center">
          <h2 className="text-3xl font-bold text-blue-600">{dashBoardData.totalEnrollments}</h2>
        ...
        <div className="bg-yellow-100 p-6 rounded-lg shadow-md text-center">
          <h2 className="text-3xl font-bold text-yellow-600">{dashBoardData.totalCourses}</h2>
            ...
            {dashBoardData?.enrolledStudents.map((item, index) => (
              <tr key={index} className="border-b hover:bg-gray-50">
                ...
                <td className="p-4 flex items-center gap-3">
                  <img src={item.student.imgUrl} alt="img" className="w-10 h-10 rounded-full shadow-md" />
