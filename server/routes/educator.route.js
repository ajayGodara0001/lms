...
import  {addCourse, addRating, checkRole, educatorCourse, educatordashboardData, getEnrolledStudensData, updateRoleToEducator}  from "../controllers/educator.controller.js"
...
educatorRoute.post('/rating/:id', addRating)
